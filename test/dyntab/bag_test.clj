...
(deftest indexer-tests
  (testing "Indexers"
    ...
    (is (= (index-pairs-by-first [1 '(a b)])
           [[:pairs-by-first 1]]))
    (is (= (index-pairs-by-fsecond [1 '(a b)])
           [[:pairs-by-fsecond 'a]]))
    (is (= (index-pairs-by-fsecond-fssecond [1 '(a (b c))])
           [[:pairs-by-fsecond-fssecond 'a 'b]]))
    (is (= (index-pairs-by-fsecond-fssecond [1 '(a b)])
           [[:pairs-by-fsecond-fssecond 'a nil]]))
